...
//    public WsClientSocketEngine(WsClientSettings settings, CmdFactoryCenter controlProxyFactory) {
//        super(controlProxyFactory);
//        this.settings=settings;
//    }
//    public WsClientSocketEngine(WsClientSettings settings,CmdFactoryCenter controlProxyFactory,EventLoopGroup eventExecutors){
//        super(controlProxyFactory);
//        this.settings=settings;
...
//        }
//        try {
//            ChannelInitializer<SocketChannel> initializer=new WsClientInitalizer(settings,controlProxyFactory);;
...
//            log.info("CmdFatoryCenter : {}", controlProxyFactory.getClass().getCanonicalName());
