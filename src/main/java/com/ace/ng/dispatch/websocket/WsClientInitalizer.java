...
//    public WsClientInitalizer(WsClientSettings settings, CmdFactoryCenter controlProxyFactory){
...
//        ch.pipeline().addLast(new WsClientInboundHandler(handshaker,controlProxyFactory));
